        ...
        <div class="col-md-6">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted">Berikut rincian data akademik Anda:</p>
                    <table class="table table-bordered">
                        <tr><th>NIM</th><td><?= $data['student_id']; ?></td></tr>
                        <tr><th>Nama Lengkap</th><td><?= $data['name']; ?></td></tr>
                        <tr><th>Jurusan / Major</th><td><?= $data['major']; ?></td></tr>
                        <tr><th>Status Akun</th><td><span class="badge bg-success">Aktif</span></td></tr>
                    </table>
                </div>
            </div>
        </div>
